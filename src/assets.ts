...
let base = [
    ...
    { name: "chat_current", url: "./ui/chat_current.png" },
    { name: "chat_input", url: "./ui/chat_input.png" },
    { name: "chat_input_bg", url: "./ui/chat_input_bg.png" },
    { name: "chat_send", url: "./ui/chat_send.png" },
